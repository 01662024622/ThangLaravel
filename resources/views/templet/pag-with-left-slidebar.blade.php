        ...
        <div class="sidebar col-xs-4">
            ...
            <div class="widget latest-posts">
                ...
                <div class="posts-container">
                	...
                	<div class="item">
                    	<img src="{{asset('img/latest-posts-1.jpg')}}" alt="post 2" class="post-image">
                        <div class="info-post">
                	...
                	<div class="item">
                    	<img src="{{asset('img/latest-posts-1.jpg')}}" alt="post 3" class="post-image">
                        <div class="info-post">
