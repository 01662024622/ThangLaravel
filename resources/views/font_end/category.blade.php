                        ...
                        <li  class="span3 gallery-item" data-id="id-1" data-type="illustration">
                            <span class="gallery-hover-4col hidden-phone hidden-tablet">
                                <span class="gallery-icons">
                                    ...
                                    <a href="{{ asset('poster/'.$post->slug) }}" class="item-details-link"></a>
                                </span>
                            </span>
        ...
        <div id="blogCarousel" class="carousel slide ">
            ...
            <div class="carousel-inner">
                ...
                <div class=" @if ($count=="1") @php $count="0"@endphp active @endif item">
                    <a href="blog-single.htm"><img src="{{ asset($post->image) }}" alt="" class="align-left blog-thumb-preview" /></a>
                    <div class="post-info clearfix">
                        <h4><a href="blog-single.htm">{{$post->title}}</a></h4>
