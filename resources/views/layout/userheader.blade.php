  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
          <a href="{{ asset('posts') }}">
            <i class="fa fa-files-o"></i> <span>All Posts Of You</span>
          </a>
          <a href="{{ asset('postedPosts') }}">
            <i class="fa fa-check"></i> <span>Posted Posts Of You</span>
          </a>
          <a href="{{ asset('browsingPosts') }}">
            <i class="fa fa-bandcamp"></i> <span>Browsing Posts Of You</span>
          </a>
          <a href="{{ asset('cancelledPosts') }}">
            <i class="fa fa-trash-o"></i> <span>Cancelled Posts Of You</span>
          </a>
          <a href=""></a>
